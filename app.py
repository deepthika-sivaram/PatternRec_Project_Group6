...
# model = SentenceTransformer('bert_recipe_model')

# Load the recipe embeddings and data
# recipe_embeddings = torch.load("recipe_embeddings.pt",weights_only=True)
...
recipes['rating'] = recipes['rating'].fillna(recipes['rating'].mean())  # fallback
...
def extract_keywords(user_input):
    ...
    # Only return nouns, adjectives, or proper nouns that are not stopwords or punctuation
    keywords = [
